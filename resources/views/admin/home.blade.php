            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td class="image-cell">
                            <div class="image">
                                <img src="{{ asset('img/rb.svg') }}" class="rounded-full">
                            </div>
                        </td>
                    ...
                    <tr>
                        <td class="image-cell">
                            <div class="image">
                                <img src="{{ asset('img/fy.svg') }}" class="rounded-full">
                            </div>
                        </td>
                    ...
                    <tr>
                        <td class="image-cell">
                            <div class="image">
                                <img src="{{ asset('img/ml.svg') }}" class="rounded-full">
                            </div>
                        </td>
...
<div id="sample-modal-2" class="modal">
    ...
    <div class="modal-card">
        <header class="modal-card-head">
            <p class="modal-card-title">Sample modal 2</p>
        </header>
        <section class="modal-card-body">
            <p>Lorem ipsum dolor sit amet <b>adipiscing elit</b></p>
            <p>This is sample modal</p>
