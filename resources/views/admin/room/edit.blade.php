            ...
            <form method="POST" action="{{ route('admin_room_update',$room_data->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="field grouped multiline">
                            ...
                            <div class="control">
                                <label class="checkbox">
                                    <input type="checkbox" name="arr_amenities[]" value="{{ $item->id }}" @if(in_array($item->id,$existing_amenities)) checked="" @endif>
                ...
                <div class="field">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control icons-left">
                                <input value="{{ $room_data->size }}" class="input" type="text" placeholder="Room Size"
                                    name="size">
                                <span class="icon left"><i class="mdi mdi-view-list"></i></span>
                            </div>
                        </div>
                ...
                <div class="field">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control icons-left">
                                <input value="{{ $room_data->total_beds }}" class="input" type="text" placeholder="Beds"
                                    name="total_beds">
                                <span class="icon left"><i class="mdi mdi-view-list"></i></span>
                            </div>
                        </div>
                ...
                <div class="field">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control icons-left">
                                <input value="{{ $room_data->total_balconies }}" class="input" type="text" placeholder="Balconies" name="total_balconies">
                                <span class="icon left"><i class="mdi mdi-view-list"></i></span>
                            </div>
                        </div>
                ...
                <div class="field">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control icons-left">
                                <input value="{{ $room_data->total_guests }}" class="input" type="text" placeholder="Guests" name="total_guests">
                                <span class="icon left"><i class="mdi mdi-view-list"></i></span>
                            </div>
                        </div>
