        ...
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4">
                <div class="text-center">
                    <h1 class="font-semibold text-white text-4xl">{{ $single_signup ->signup_heading }}</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-wrap -mx-4">
            ...
            " data-wow-delay=".15s">
                    ...
                    <form action="{{ route('customer_signup_submit') }}" method="post">
                        @csrf
                        <div class="mb-6">
                            <input value="{{ old('name') }}" name="name" type="name" placeholder="Name" class="
                                w-full
                                rounded-md
                                border
                                bordder-[#E9EDF4]
                        ...
                        <div class="mb-6">
                            <input name="password" value="{{ old('password') }}" type="password" placeholder="Password" class="
                                w-full
                                rounded-md
                                border
                                bordder-[#E9EDF4]
                        ...
                        <div class="mb-6">
                            <input value="{{ old('retype_password') }}" name="retype_password" type="password" placeholder="Retype Password" class="
                                w-full
                                rounded-md
                                border
                                bordder-[#E9EDF4]
                            ...
                            <span class="text-red">{{ $errors->first('retype_password') }}</span>
                            @endif
                        </div>
                        <div class="mb-10">
                    ...
                    <p class="text-base text-[#adadad]">
                        Not a member yet?
                        <a href="{{ route('customer_login') }}" class="text-primary hover:underline">
                            Sign Up
                        </a>
                    </p>
