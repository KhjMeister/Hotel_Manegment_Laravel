        ...
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4">
                <div class="text-center">
                    <h1 class="font-semibold text-white text-4xl">{{ $global_page_data->reset_password_heading }}</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-wrap -mx-4">
            ...
            " data-wow-delay=".15s">
                    ...
                    <form action="{{ route('customer_reset_password_submit') }}" method="post">
                        ...
                        <div class="mb-6">
                            <input name="retype_password" type="password" placeholder="Confirm Password" class="
                                w-full
                                rounded-md
                                border
                                bordder-[#E9EDF4]
