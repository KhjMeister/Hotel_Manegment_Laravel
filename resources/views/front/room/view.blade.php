    ...
    <div
        ...
        <div class="divide-gray-300 divide-y space-y-5 relative">
            ...
            <div class="relative">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-auto text-gray-600 text-sm ">(8)</div>
            ...
            <div class="pt-4">
                ...
                <h3 class="text-xl text-gray-800 mb-3 uppercase font-medium ">Brand </h3>
                <div class="space-y-2">
                    <!-- ----Single Brand  --->
                    <div class="flex items-center">
                    ...
                    <!-- ----Single Brand  --->
                    <div class="flex items-center">
                        <input type="checkbox" id="Zara" class="text-primary focus:ring-0 rounded-sm cursor-pointer " />
                        <label for="Zara" class="text-gray-600 ml-3 cursor-pointer  ">Zara</label>
                        <div class="ml-auto text-gray-600 text-sm ">(8)</div>
