...
class BookingController extends Controller
{
    ...
    public function payment_submit(Request $request)
    {
        ...
        if($method == 1)
        {
            ...
            $obj->transaction_id = rand(111111,999999);
            ...
            $message .= '<br>Transaction Id: '.rand(111111,999999);
        ...
        elseif($method == 2)
        {
            $stripe_secret_key = 'sk_test_51LqmsCFTsSHP3Jx3GKEXsvLUswJf4pZM21Bs7S4LzGUu84ssfxYf6NuVcEbT4Zkq10p2O6vpq5d0QRHuZ5sCTH1D00ephsv9hW';
